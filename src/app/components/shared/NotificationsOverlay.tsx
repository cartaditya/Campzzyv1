...
export function NotificationsOverlay({ open, onClose }: Props) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 500, background: "rgba(15,25,35,0.70)" }}>
      <div
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "1rem 1.25rem", background: "#0A0A0A" }}>
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
              {HACKATHONS.map((h) => (
                <div key={h.id} style={{ background: "#111111", border: "1px solid #1E1E1E", borderRadius: "10px", padding: "14px", cursor: "pointer" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
              {HIRING.map((j) => (
                <div key={j.id} style={{ background: "#111111", border: "1px solid #1E1E1E", borderRadius: "10px", padding: "14px", cursor: "pointer" }}>
                  <div style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
