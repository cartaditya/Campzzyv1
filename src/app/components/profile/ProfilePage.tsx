  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ background: "#fff", borderBottom: `1px solid ${C.border}`, padding: "0 1.25rem", height: "56px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 30 }}>
        <button onClick={() => navigate(-1)} style={{ display: "flex", alignItems: "center", gap: "0.35rem", background: "none", border: "none", cursor: "pointer", color: C.subtle, fontWeight: 700, fontSize: "0.85rem", fontFamily: "inherit" }}>
      ...
      <div style={{ maxWidth: "680px", margin: "0 auto", padding: "1.5rem 1rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
          <div onClick={() => console.log("Professional Connections clicked")} style={{ background: "#fff", border: `1px solid ${C.border}`, borderRadius: "16px", padding: "1.25rem", textAlign: "center", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", cursor: "pointer" }}>
          ...
          <div onClick={() => console.log("Social Connections clicked")} style={{ background: "#fff", border: `1px solid ${C.border}`, borderRadius: "16px", padding: "1.25rem", textAlign: "center", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", cursor: "pointer" }}>
        ...
        <div style={{ background: "#fff", border: `1px solid ${C.border}`, borderRadius: "16px", padding: "1.25rem", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0.75rem" }}>
            {[
              ...
              <div key={stat.label} style={{ background: C.bg, border: `1px solid ${C.border}`, borderRadius: "12px", padding: "0.75rem 0.5rem", textAlign: "center", cursor: "pointer", transition: "transform 0.2s" }} onMouseEnter={(e) => { const card = e.currentTarget as HTMLDivElement; card.style.transform = "scale(1.05)"; }} onMouseLeave={(e) => { const card = e.currentTarget as HTMLDivElement; card.style.transform = "scale(1)"; }}>
