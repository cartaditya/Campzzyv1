    ...
    <div style={{ display: "flex", height: "100vh", background: C.slate, fontFamily: "'Inter', system-ui, sans-serif", overflow: "hidden" }}>
      ...
      <aside style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem" }}>
          <button onClick={() => navigate("/profile")} style={{ width: "40px", height: "40px", borderRadius: "50%", background: "#22c55e", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.72rem", fontWeight: 800, color: "#ffffff", transition: "color 0.2s ease, opacity 0.2s ease" }}>
            AH
          </button>
            ...
            <div style={{ width: "38%", background: N.bg, borderRight: `1px solid ${N.border}`, display: "flex", flexDirection: "column", overflowY: "auto", flexShrink: 0 }}>
              ...
              <div style={{ padding: "1rem 1.25rem", borderBottom: `1px solid ${N.border}`, flexShrink: 0 }}>
                <div style={{ display: "flex", alignItems: "flex-end", gap: "0.5rem" }}>
                  ...
                  <div
                    style={{ flex: 1, textAlign: "center", cursor: "pointer", transition: "transform 0.16s ease, opacity 0.16s ease" }}
              ...
              <div>
                {LEADERBOARD.map((entry) => (
                  <div key={entry.rank} style={{ display: "grid", gridTemplateColumns: "36px 1fr 70px 56px", padding: "0.65rem 1.25rem", borderBottom: `1px solid rgba(30,45,64,0.4)`, background: entry.isMe ? "rgba(77,217,192,0.05)" : "transparent", alignItems: "center", position: "relative", cursor: "pointer", transition: "background 0.16s ease, transform 0.16s ease" }} onMouseEnter={(e) => { const row = e.currentTarget as HTMLDivElement; row.style.background = entry.isMe ? "rgba(77,217,192,0.09)" : "rgba(255,255,255,0.03)"; row.style.transform = "translateY(-1px)"; }} onMouseLeave={(e) => { const row = e.currentTarget as HTMLDivElement; row.style.background = entry.isMe ? "rgba(77,217,192,0.05)" : "transparent"; row.style.transform = "translateY(0)"; }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0.875rem" }}>
                  {GAMES.map((game) => (
                    <button
                      ...
                      style={{ background: "transparent", border: "none", borderRadius: "0", padding: "1.1rem 0.75rem 0.9rem", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.55rem", fontFamily: "inherit", transition: "all 0.18s", position: "relative", overflow: "visible" }}
                      onMouseEnter={(e) => {
